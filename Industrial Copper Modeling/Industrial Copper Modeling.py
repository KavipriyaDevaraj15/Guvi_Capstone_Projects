...
with tab1:
    ...
    country_options = [25., 26., 27., 28., 25., 30., 32., 38., 78., 27., 77., 113., 79., 26., 39., 40., 84., 80., 89., 107., 113.]
    application_options = [2., 3., 4., 5., 10., 15., 19., 20., 22., 25., 26., 27., 28., 29., 38., 39., 40., 41., 42., 56., 58., 59., 65.,
                           66., 67., 68., 69., 70., 39., 79., 99.]
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\\Users\\KAVIPRIYA\\Desktop\\ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:#ee4647;">App Created by KAVIPRIYA</h6>', unsafe_allow_html=True)
