...
class App:
    ...
    def model(self):
        ...
        st.set_page_config(page_title="Retail-Sales-Forecast | By Kavipriya", layout="wide")
        ...
        if selected == "Weeklysales_Prediction":
            ...
            with col2:
               ...
               # IH = {'False':0, 'True':1}
                ...
                with open('F_regression.pkl', 'rb') as f:
                    model = pickle.load(f)
            ...
            with col1:
                ...
                if st.button('Process'):
                    ...
                    st.markdown(
                        f"<h1 style='font-size: 30px;'><span style='color: cyan;'>Predicted Weekly_Sales : </span><span style='color: Black;'> {x[0]}</span> </h1>",
                        unsafe_allow_html=True)
