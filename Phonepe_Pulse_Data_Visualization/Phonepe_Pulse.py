...
conn = mysql.connector.connect(user='root', password='Saikavi@123', host='127.0.0.1', database="phonepe_pulse")
...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\KAVIPRIYA\\Desktop\\Phonepe_image2.png"), width=300)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:\\Users\\KAVIPRIYA\\Desktop\\upi.mp4")
...
if SELECT == "About":
    col1, col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\KAVIPRIYA\\Desktop\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\KAVIPRIYA\\Desktop\\Phonepe_image2.png"), width=500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\KAVIPRIYA\\Desktop\\about_phonepe.jpg"), width=400)
        with open("C:\\Users\\KAVIPRIYA\\Desktop\\about_phonepe1.png", "rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT", data, file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\\Users\\KAVIPRIYA\\Desktop\\about_phonepe1.png"), width=600)
