...
conn = mysql.connector.connect(user='root', password='SAIkavi@1234', host='127.0.0.1', database="phonepe_pulse")
...
if SELECT == "Home":
    ...
    col1.image(Image.open("C:\\Users\\HP\\Desktop\\Phonepe_image2.png"),width = 300)
    with col1:
    ...
    with col2:
        st.video("C:\\Users\\HP\\Desktop\\upi.mp4")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\\Users\\HP\\Desktop\\Statenames.csv")
            df1.State = df2
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video("C:\\Users\\HP\\Desktop\\pulse-video.mp4")
    with col2:
        st.image(Image.open("C:\\Users\\HP\\Desktop\\Phonepe_image2.png"),width = 500)
        st.write("---")
    ...
    with col1:
        ...
        st.image(Image.open("C:\\Users\\HP\\Desktop\\about_phonepe.jpg"),width = 400)
        with open("C:\\Users\\HP\\Desktop\\about_phonepe1.png","rb") as f:
            data = f.read()
        st.download_button("DOWNLOAD REPORT",data,file_name="annual report.pdf")
    with col2:
        st.image(Image.open("C:\Users\HP\Desktop\about_phonepe1.png"),width = 800)
